...
export const CompanionRoomPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const ws = new WebSocket(`${protocol}//${window.location.host}/ws/companion?token=${encodeURIComponent(token || '')}`);
    wsRef.current = ws;
  ...
  return (
    <div className="companion-container">
      ...
      <div className="companion-grid">
        <div className="companion-left-col">
        ...
        <div className="companion-right-col">
