...
// RealtimeCompanionConn 统一音视频面试官连接的抽象适配器接口
type RealtimeCompanionConn interface {
...
func NewGeminiRealtimeConn(apiKey string, model string) (RealtimeCompanionConn, error) {
...
func NewQwenRealtimeConn(apiKey string, model string) (RealtimeCompanionConn, error) {
	headers := http.Header{}
...
func NewMockRealtimeConn() (RealtimeCompanionConn, error) {
